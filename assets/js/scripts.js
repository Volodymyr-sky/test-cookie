            ...
            <div class="tabs js-tabs">
              ...
              <div class="js-tabs__panels">
                <section id="tab1Panel1" class="padding-top-md js-tabs__panel">
                  <p>${this.options.modal.tabs[0].description}</p>
                  ...
                  <ul class="accordion  js-accordion" data-animation="on" data-multi-items="on">
                    ...
                    <li class="accordion__item js-accordion__item">
                      <button class="reset accordion__header js-tab-focus" type="button">
                        <div class="width-100%">
                          <div class="text-md font-bold">Necessery</div>
                          <div class="flex justify-between">
                            <div>
                              These cookies are required for good functionality of our website and can't be switched off in our system.
                            </div>
                            <div class="switch ">
                              <input class="switch__input" type="checkbox" id="switch-checkbox-1" checked disabled>
                        ...
                        <div class="accordion-more">
                          <div class="margin-right-sm">more</div>
                          <svg class="icon icon-xs accordion__icon-arrow no-js:is-hidden" height="16" width="16" viewBox="0 0 20 20" aria-hidden="true">
                      ...
                      <div class="accordion__panel padding-top-xxs js-accordion__panel">
                        <div class="text-component">
                          <p>Usually these cookies are set by your actions in your requests for our services. Examples of these actions are logging in, filling in forms or setting your privacy preferences. It is possible to make your browser block these cookies, but some parts of our website may not work properly when these are blocked.</p>
                          <p>Shared with Linkobox.</p>
                        </div>
                      </div>
                    </li>
                      ...
                      <button class="reset accordion__header js-tab-focus" type="button">
                        <div class="width-100%">
                          ...
                          <div class="flex justify-between">
                            ...
                            <div class="switch ">
                              <input class="switch__input" type="checkbox" id="switch-checkbox-2">
                              <label class="switch__label" for="switch-checkbox-2" aria-hidden="true">Option label</label>
                              <div class="switch__marker" aria-hidden="true"></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <button class="reset accordion__header js-tab-focus" type="button">
                        <div class="width-100%">
                          ...
                          <div class="flex justify-between">
                            ...
                            <div class="switch ">
                              <input class="switch__input" type="checkbox" id="switch-checkbox-3">
                              <label class="switch__label" for="switch-checkbox-3" aria-hidden="true">Option label</label>
                              <div class="switch__marker" aria-hidden="true"></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <button class="reset accordion__header js-tab-focus" type="button">
                        <div class="width-100%">
                          ...
                          <div class="flex justify-between">
                            ...
                            <div class="switch ">
                              <input class="switch__input" type="checkbox" id="switch-checkbox-4">
                              <label class="switch__label" for="switch-checkbox-4" aria-hidden="true">Option label</label>
                              <div class="switch__marker" aria-hidden="true"></div>
                            </div>
                          </div>
                        </div>
                ...
                <section id="tab1Panel2" class="padding-top-md js-tabs__panel">
                  <div class="text-component">
                    <p>${this.options.modal.tabs[1].description}</p>
                ...
                <section id="tab1Panel3" class="padding-top-md js-tabs__panel">
                  <div class="text-component">
                    <p>${this.options.modal.tabs[2].description}</p>
                    <p><span class="font-bold">updated:</span> ${this.options.modal.tabs[2].updated}</p>
                  </div>
                  <ul>
                    <li class="margin-bottom-md">
                      <div class="text-md font-bold margin-bottom-xs">Necessery</div>
                      <div class="font-bold margin-bottom-xxxs">__cfduid</div>
                      <div class="font-italic margin-bottom-xxxs">.app-us1.com</div>
                      <div>Cookie is set on websites using Cloudflare to speed up their load times and for threat defense services. It is does not collect or share user identification information.
                      </div>
                    </li>
                  </ul>
                </section>
